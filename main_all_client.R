...
query_enrolment <- paste(
  ...
  , '1' AS Enrol_Enrolled
  FROM [recon].[dbo].[Enrolment_Data] ORDER BY crms_number desc, Enrol_DateCreated desc,
...
query_IntComm <- paste(
  ...
  FROM [synergygdw].[dbo].[TableauEnquiryMadeOfferInternationalCommunicationsView]",sep = ""
)

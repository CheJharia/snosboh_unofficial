...
# read utas
utas.raw.scores <- tbl_df(read.csv(file = 'UTAS-New-Scores.csv'
                                   ,header = T
                                   ,sep = ','
                                   ,check.names = F))
...
#write.csv(x = utas_profiled
#          ,file = 'utas_reprofiled_apac_model.csv'
#          ,row.names = F)
# utas_profiled <- read.csv(file = 'utas_reprofiled_apac_model.csv', header = T,check.names = F)

...
setwd("C:/Users/afiq.johari/Documents/Data Scientist/Incoming_Data/!Enquiry/New")
...
for (gfile in Enq_files) {
  ...
  (dirpath <- paste("C:/Users/afiq.johari/Documents/Data Scientist/Incoming_Data/!Enquiry",'/!Files/',fname, sep = ""))
  dir.create(dirpath)

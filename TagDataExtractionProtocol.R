...
setwd("C:/Users/afiq.johari/Documents/Data Scientist/Incoming_Data/!Tag/New")
...
for (gfile in Enq_files) {
  ...
  (dirpath <- paste("C:/Users/afiq.johari/Documents/Data Scientist/Incoming_Data/!Tag",'/!Files/',fname, sep = ""))
  dir.create(dirpath)
